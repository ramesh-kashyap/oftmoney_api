            ...
            <div class="container-fluid">
				...
				<div class="row page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="javascript:void(0)">Approved Withdraw</a></li>
					</ol>
                </div>
                <!-- row -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Approved Withdraw</h4>
                            </div>
                            <div class="card-body">
                                       <form action="approved-withdraw" method="GET">
                                        <div class="row">
                                            <div class="col-xl-4">
                                            ...
                                            <div class="col-xl-2">
                                                <div class="form-group mb-3">
                                                    <a href="{{asset('')}}admin/approved-withdraw" style="padding: 0.6rem 2rem;" name="reset" class="btn btn-outline-theme btn-lg d-block w-100 btn-primary" value="Reset">Reset</a>
                                                </div>
                                            </div>
                                ...
                                <div class="table-responsive">
                                    <div id="example_wrapper" class="dataTables_wrapper no-footer">
                                        ...
                                        <table id="example" class="display dataTable no-footer" style="min-width: 845px"
                                            ...
                                            <tr role="row">
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="example" rowspan="1"
                                                    ...
                                                    style="width: 73.1562px;">Plan</th>
                                                <th class="sorting" tabindex="0" aria-controls="example" rowspan="1"
                                                    colspan="1" aria-label="User Id: activate to sort column ascending"
                                                    style="width: 53.5833px;">Telegram Id</th>
                                                <th class="sorting" tabindex="0" aria-controls="example" rowspan="1"
                                        ...
                                        <tbody>
                                            @php
                                                                $i = ($ApprovedReport->currentPage() - 1) * $ApprovedReport->perPage();
                                                            @endphp                                       
                                                   @forelse($ApprovedReport as $user)                 
