                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                    ...
                                    <form action="active-user" method="GET">
                                        <div class="row">
                                            <div class="col-xl-4">
                                            ...
                                            <div class="col-xl-2">
                                                <div class="form-group mb-3">
                                                    <a href="{{asset('')}}admin/active-user" style="padding: 0.6rem 2rem;" name="reset" class="btn btn-outline-theme btn-lg d-block w-100 btn-primary" value="Reset">Reset</a>
                                                </div>
                                            </div>
                                ...
                                <div class="table-responsive">
                                    <div id="example_wrapper" class="dataTables_wrapper no-footer">
                                        ...
                                        <tbody>
                                                 ...
                                                 <tr class="odd" role="row">
                                                    ...
                                                    <td><span class="badge bg-success">{{ $user->active_status }}</span>
                                                    </td>
                                    ...
                                    <div class="dataTables_paginate paging_simple_numbers" id="example_paginate"><a
                                            ...
                                            data-dt-idx="0" tabindex="0" id="example_previous"><i
                                            ...
                                            aria-controls="example" data-dt-idx="2" tabindex="0" id="example_next"><i
